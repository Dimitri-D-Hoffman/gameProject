...
custom_cursor = pygame.image.load('venv/img/files/img/Icons/sword.png').convert_alpha()
potion_img = pygame.image.load('venv/img/files/img/Icons/potion.png').convert_alpha()
...
# background images
background_forest_0 = pygame.image.load('venv/img/files/img/Background/Forest1.png').convert_alpha()


# panel image
panel_img = pygame.image.load('venv/img/files/img/Icons/panel.png').convert_alpha()
...
class Fighter():
    ...
    # load idle images
        temp_list =[]
        for i in range (8):
            charImg = pygame.image.load(f'venv/img/files/img/{self.name}/Idle/{i}.png')
    ...
    # load attack images
        temp_list =[]
        for i in range (8):
            charImg = pygame.image.load(f'venv/img/files/img/{self.name}/Attack/{i}.png')
            charImg = pygame.transform.scale(charImg, (charImg.get_width() * 3, charImg.get_height() * 3))
            temp_list.append(charImg)
        self.animation_list.append(temp_list)
